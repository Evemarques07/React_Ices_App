// Primeiro, instale as dependências: npm install jspdf html2canvas
...
import {
  ...
  Rocket,
  HeartHandshake,
  Share2, // Ícone para o novo botão
} from "lucide-react";
...
export default function Relatorios() {
  ...
  const [isSharing, setIsSharing] = useState(false); // Para o estado de loading do botão de compartilhar
  ...
  // Função principal para gerar e compartilhar o PDF
  async function handleShare(type = "detalhado") {
    setShowShareModal(false); // Fecha o modal de escolha
    setIsSharing(true); // Ativa o estado de loading

    try {
      // Buscar os dados do relatório antes de renderizar o PDF
      const user = JSON.parse(localStorage.getItem("user"));
      if (!user || !user.access_token) {
      ...
      // Renderiza o layout do relatório como HTML string
  ...
  return (
    <div className="container-principal relatorios-page">
      ...
      {!loading && !error && relatorio && (
        <div id="relatorio-para-pdf">
          ...
          <div className="relatorio-content">
            ...
            {/* O resto do seu JSX do relatório continua aqui... */}
      ...
      {/* Modal de escolha do tipo de relatório */}
      {showShareModal && (
        ...
        <table className="transactions-table">
          <thead>
            <tr>
              ...
              <th>Descrição</th>
              <th>Data</th>
              {/* Adicionada a classe para ser alvo do seletor JS */}
